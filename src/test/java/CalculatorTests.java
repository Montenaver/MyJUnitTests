import org.example.CalculatorDemo;
...
public class CalculatorTests {
    ...
    public void addTest(double[] data) {
        Assertions.assertEquals(data[2], calculatorDemo.add(data[0], data[1]),
                "Calculator sum is not expected");
    }

    @Disabled("Disabled until bug #99 has been fixed")//https://junit.org/junit5/docs/current/user-guide/#writing-tests-disabling
    @Test
